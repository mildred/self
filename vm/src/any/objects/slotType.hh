...
class slotTypeClass {
 public:
  ...
  // accessors
  fint slot_type()    { return maskBits(pint(this), slot_type_mask); }
  ...
  bool is_vm_slot()   { return isSet(pint(this), is_vm_slot_shift); }
  bool is_parent()    { return isSet(pint(this), is_parent_shift); }
